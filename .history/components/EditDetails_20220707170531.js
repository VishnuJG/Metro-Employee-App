...
export default function EditDetails({ticket}) {
    const firstUpdate  = useRef(true);

    const [employees,setEmployees] = useState([])
  
    const [emp, onEmpUpdate] = useState({
        name: props.route.params.ticket.name,
        email: props.route.params.ticket.email,
        location: props.route.params.ticket.location 
      });

...

    {
        tickets.map(ticket => {
            return(
                ...
                <DataTable.Row key={ticket.id} onPress={()=>{()=>{props.navigation.navigate("Edit",{emp:emp})};Alert.alert('Employee Data', `Ticket Type : ${emp.name}\n\nTicket Sub-type : ${emp.email}\n\nTicket Description : ${emp.location}`,[{text:"Edit", onPress:()=>{props.navigation.navigate("Edit",{emp:emp})}},{text:"Delete", onPress:()=>{}}])}}></DataTable.Row>

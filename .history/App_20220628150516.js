...
export default function App() {
  ...
  return (
    <View style={styles.container} >
        ...
        <ScrollView   >
        <DataTable style={{flex:1, flexDirection: 'column', }} >
          <DataTable.Header style={styles.tableHeader}>
            <DataTable.Title style={styles.employee}>Id</DataTable.Title>
            <DataTable.Title style={styles.employee}>Name</DataTable.Title>
            <DataTable.Title style={styles.employee}>Email</DataTable.Title>
          </DataTable.Header>

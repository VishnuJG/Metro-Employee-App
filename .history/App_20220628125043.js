...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Submit"
        color="green" 
        onPress={() => Alert.alert('Please enter Name', 'A Simple alert message displayed',[{text: 'Yes', onPress:()=>{console.log("Yes Pressed")}},{text: 'No', onPress:()=>{console.log("No Pressed")}}])}
        />
    </View>
  );
}
